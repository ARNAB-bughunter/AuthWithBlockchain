...
class productDetailForm(forms.ModelForm):
	class Meta:
		model=productDetail
		fields=['productName','productDescription','image','manufacturer']
		...
		'manufacturer':forms.Textarea(attrs={'type':'textarea','rows':'2','class':'form-control','placeholder':"Enter Your Company Name",'required':'true'}),
